    ...
    export default {
        ...
        setup(){
            ...
            const clickTorchHead=()=>{ // 摸头
                store.commit('addTime', 2)
                addLog('train', `${name}摸了摸${current_lili.name}的头，${current_lili.name}蹭了蹭主人表示回应。`, true)
            ...
            const clickTorchBreast=()=>{ // 摸胸
                ...
                addLog('train', `${name}摸了摸${current_lili.name}的胸胸，${current_lili.name}有些害羞地躲开了。`, true)
            ...
            const clickTorchVagina=()=>{ // 摸下体
                ...
                addLog('train', `${name}摸了摸${current_lili.name}的下面，${current_lili.name}的性欲增加了。`, true)
            ...
            const clickTorchEar=()=>{ // 耳尖吹气
                store.commit('addTime', 2)
                addLog('train', `${name}在${current_lili.name}的耳边轻轻吹气，${current_lili.name}的耳尖很快变红了。`, true)
            ...
            const clickWhipButt=()=>{ // 打屁股
                store.commit('addTime', 10)
                addLog('train', `${name}抽打了一番${current_lili.name}，${current_lili.name}的小屁屁很快变红。`, true)
                current_lili = changeAttributes({input_lili:current_lili, servility:5, favorability:-5, lust:-5})
                handleWhip()
            }
            ...
            const clickWhipBreast=()=>{ // 打胸胸
                store.commit('addTime', 10)
                addLog('train', `${name}抽打了一番${current_lili.name}的胸胸，${current_lili.name}吃痛躲开。`, true)
            ...
            const clickWhipHand=()=>{ // 打手心 
                store.commit('addTime', 10)
                addLog('train', `${name}抽打了一番${current_lili.name}的手心，${current_lili.name}缩回了手。`, true)
            ...
            const clickWhipFoot=()=>{ // 打脚心
                store.commit('addTime', 10)
                addLog('train', `${name}抽打了一番${current_lili.name}的脚心，${current_lili.name}痛呼出声。`, true)
                current_lili = changeAttributes({input_lili:current_lili, servility:5, favorability:-5, lust:-5})
                handleWhip()
            }
            ...
            const clickWhipVagina=()=>{ // 打下体
                store.commit('addTime', 5)
                addLog('train', `${name}抽打了一番${current_lili.name}的下体，${current_lili.name}的性欲大幅度下降了。`, true)
            ...
            const clickElectricLap=()=>{ // 电大腿
                store.commit('addTime', 10)
                addLog('train', `${name}将电击贴片贴在${current_lili.name}的大腿，并打开了电击器。`, true)
                current_lili = changeAttributes({input_lili:current_lili, servility:5, favorability:-5, lust:-5})
                handleElectric()
            }
            ...
            const clickElectricFoot=()=>{ // 电脚心
                store.commit('addTime', 10)
                addLog('train', `${name}将电击贴片贴在${current_lili.name}的脚心，并打开了电击器。`, true)
                current_lili = changeAttributes({input_lili:current_lili, servility:5, favorability:-5, lust:-5})
                handleElectric()
            }
            ...
            const clickElectricVagina=()=>{ // 体内电击
                store.commit('addTime', 5)
                addLog('train', `${name}将电击棒插入了${current_lili.name}的下体，并打开了电击器。`, true)
            ...
            const clickSexStop=()=>{ // 寸止
                ...
                addLog('train', `${name}将震动棒贴在${current_lili.name}下体，并在${current_lili.name}即将高潮时移开了震动棒。`, true)
            ...
            const clickSexOrgasm=()=>{ // 强高
                store.commit('addTime', 30)
                addLog('train', `${name}将震动棒贴在${current_lili.name}下体，${current_lili.name}很快达到了高潮。`, true)
                current_lili = changeAttributes({input_lili:current_lili, servility:10, favorability:10, lust:-100})
                handleSex()
            }

            const clickSexWalkRope=()=>{ // 走绳
                store.commit('addTime', 60)
                addLog('train', `${name}将${current_lili.name}固定在一根布满绳结的粗麻绳上，并强迫${current_lili.name}来回走动。`, true)
            ...
            const clickTkFoot=()=>{ // 挠脚心
                ...
                addLog('train', `${name}挠了挠${current_lili.name}的脚心，${current_lili.name}发出银铃般的笑声。`, true)
            ...
            const clickTkArmpit=()=>{ // 挠腋窝
                store.commit('addTime', 20)
                addLog('train', `${name}挠了挠${current_lili.name}的腋窝，${current_lili.name}发出银铃般的笑声。`, true)
                current_lili = changeAttributes({input_lili:current_lili, servility:5})
                handleTk()
            }
            ...
            const clickTkLap=()=>{ // 挠大腿
                store.commit('addTime', 20)
                addLog('train', `${name}挠了挠${current_lili.name}的大腿，${current_lili.name}发出银铃般的笑声。`, true)
                current_lili = changeAttributes({input_lili:current_lili, servility:5})
                handleTk()
            }
            ...
            const clickTkCostal=()=>{ // 数肋骨
                store.commit('addTime', 20)
                addLog('train', `${name}戳了戳${current_lili.name}的肋下，${current_lili.name}发出银铃般的笑声。`, true)
                current_lili = changeAttributes({input_lili:current_lili, servility:5})
                handleTk()
            }
            ...
            const clickSmellSocks=()=>{ // 闻袜子
                store.commit('addTime', 20)
                addLog('train', `${name}将臭袜子固定在${current_lili.name}的鼻尖，强迫${current_lili.name}呼吸酸臭的气味。`, true)
            ...
            const clickSmellPanties=()=>{ // 闻内裤
                store.commit('addTime', 10)
                addLog('train', `${name}将胖次固定在${current_lili.name}的鼻尖，强迫${current_lili.name}呼吸酸臭的气味。`, true)
                current_lili = changeAttributes({input_lili:current_lili, servility:10})
                handleSmell()
            }
