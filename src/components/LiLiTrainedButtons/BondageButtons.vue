    ...
    export default {
        ...
        setup(){
            ...
            const clickBlindfold=()=>{ // 戴上眼罩
                store.commit('addLog', `${name}给${current_lili.name}戴上了眼罩，${current_lili.name}眼前漆黑一片。\n`)
                store.commit('addMinute', 1)
            ...
            const untieBlindfold=()=>{ // 解开眼罩
                store.commit('addLog', `${name}给${current_lili.name}摘下了眼罩。\n`)
                current_lili = changeAttributes({input_lili:current_lili, bondage_eye:-10})
                flags.blindfold_flag = 1
            ...
            const clickBallgag=()=>{ // 戴上口球
                store.commit('addLog', `${name}给${current_lili.name}戴上了口球，堵住了${current_lili.name}的小嘴。\n`)
                store.commit('addMinute', 3)
            ...
            const untieBallgag=()=>{ // 摘下口球
                store.commit('addLog', `${name}给${current_lili.name}摘下了口球。\n`)
                current_lili = changeAttributes({input_lili:current_lili, bondage_mouth:-5})
                flags.ballgag_flag = 1
            ...
            const clickEarplug=()=>{ // 戴上耳塞
                store.commit('addLog', `${name}给${current_lili.name}戴上了耳塞，${current_lili.name}的耳边安静了一些。\n`)
                store.commit('addMinute', 1)
            ...
            const untieEarplug=()=>{ // 摘下耳塞
                store.commit('addLog', `${name}给${current_lili.name}摘掉了耳塞。\n`)
                current_lili = changeAttributes({input_lili:current_lili, bondage_ear:-5})
                flags.earplug_flag = 1
            ...
            const clickFrontHandBinding=()=>{ // 捆绑前手缚
                store.commit('addLog', `${name}将${current_lili.name}的双手在身前捆绑。\n`)
            ...
            const untieFrontHandBinding=()=>{ // 解开前手缚
                store.commit('addLog', `${name}给${current_lili.name}解开了双手的束缚。\n`)
            ...
            const clickBackHandBinding=()=>{ // 捆绑后手缚
                store.commit('addLog', `${name}将${current_lili.name}的双手在身后反绑。\n`)
            ...
            const clickBoxBinding=()=>{ // 日式盒缚
                store.commit('addLog', `${name}将${current_lili.name}的双手在身后平行反绑，多余的绳索缠绕过胸部上下，将她的胸胸勒得更加丰满。\n`)
            ...
            const clickStraightArmBinding=()=>{ // 欧式直臂
                store.commit('addLog', `${name}将${current_lili.name}的双手反剪，从手腕到大臂均并拢捆紧，让她的双臂无法分开。\n`)
                store.commit('addMinute', 20)
            ...
            const clickBackPrayerBinding=()=>{ // 后手观音
                store.commit('addLog', `${name}将${current_lili.name}的双手在背后吊高，手指向上呈反拜姿势，将手腕到手肘分别捆紧，大小臂也折叠紧缚在一起。\n`)
            ...
            const clickTapeWrapFingers=()=>{ // 胶带包手
                store.commit('addLog', `${name}将${current_lili.name}的双手握拳，用胶带包裹成两个圆球。\n`)
                store.commit('addMinute', 10)
            ...
            const untieTapeWrapFingers=()=>{ // 解开胶带包手
                store.commit('addLog', `${name}给${current_lili.name}解开了手指的束缚。\n`)
            ...
            //     store.commit('addLog', `${name}在${current_lili.name}的身前编织出龟甲状绳衣。\n`)
            //     current_lili = changeAttributes({input_lili:current_lili, pleasure_breast:1})
            ...
            //     store.commit('addLog', `${name}给${current_lili.name}解开了身上的龟甲缚绳衣。\n`)
            //     current_lili = changeAttributes({input_lili:current_lili, pleasure_breast:-1})
            //     flags.tortoiseshell_binding_flag = 1
            ...
            const clickLegBinding=()=>{ // 并腿缚
                store.commit('addLog', `${name}将${current_lili.name}的双腿并拢捆绑起来。\n`)
            ...
            const untieLegBinding=()=>{ // 解开并腿缚
                store.commit('addLog', `${name}给${current_lili.name}解开了双腿的束缚。\n`)
                store.commit('addMinute', 10)
            ...
            const clickOpenLegBinding=()=>{ // M字开腿缚
                store.commit('addLog', `${name}将${current_lili.name}的双腿分别折叠捆紧。\n`)
            ...
            const clickBallBinding=()=>{ // 桃缚
                store.commit('addLog', `${name}将${current_lili.name}的双腿分别折叠捆紧后将脚踝交叉捆绑，并连接绳索到脖颈，将${current_lili.name}头部和脚踝逐渐拉近。\n`)
                store.commit('addMinute', 20)
            ...
            const untieBallBinding=()=>{ // 解开桃缚
                store.commit('addLog', `${name}给${current_lili.name}解开了桃缚。\n`)
            ...
            //     store.commit('addLog', `${name}给${current_lili.name}绑上股绳，并在下体敏感位置留下几个大大的绳结。\n`)
            //     current_lili = changeAttributes({input_lili:current_lili, pleasure_vagina:1})
            //     flags.strand_rope_flag = 2
            //     special_bondage_flags.push('strand_rope_flag')
            //     handleBondage()
            // }
            // const untieStrandRope=()=>{ // 解开股绳
            //     store.commit('addLog', `${name}给${current_lili.name}解开了股绳。\n`)
            //     current_lili = changeAttributes({input_lili:current_lili, pleasure_vagina:-1})
            //     flags.strand_rope_flag = 1
            ...
            const clickK9Binding=()=>{ // K9拘束衣
                store.commit('addLog', `${name}给${current_lili.name}套上K9拘束服，打扮成四肢着地的宠物样子。\n`)
                store.commit('addMinute', 20)
            ...
            const untieK9Binding=()=>{ // 解开K9拘束衣
                store.commit('addLog', `${name}给${current_lili.name}解开了K9拘束衣。\n`)
            ...
            const clickHorseBinding=()=>{ // 马奴拘束
                store.commit('addLog', `${name}给${current_lili.name}打扮成马驹的样子。\n`)
                store.commit('addMinute', 20)
            ...
            const untieHorseBinding=()=>{ // 解开马奴拘束
                store.commit('addLog', `${name}给${current_lili.name}解开了马奴拘束衣。\n`)
            ...
            const clickXBinding=()=>{ // X架拘束
                store.commit('addLog', `${name}将${current_lili.name}禁锢到X型拘束架上。\n`)
                store.commit('addMinute', 20)
            ...
            const untieXBinding=()=>{ // 解开X架拘束
                store.commit('addLog', `${name}将${current_lili.name}从X型拘束架上放下来。\n`)
            ...
            const clickMermaidBinding=()=>{ // 乳胶人鱼拘束衣
                store.commit('addLog', `${name}给${current_lili.name}套上乳胶人鱼拘束衣。\n`)
                store.commit('addMinute', 30)
            ...
            const untieMermaidBinding=()=>{ // 解开乳胶人鱼拘束衣
                store.commit('addLog', `${name}给${current_lili.name}脱掉乳胶人鱼拘束衣。\n`)
            ...
            const clickMummifiedHeadBinding=()=>{ // 绷带木乃伊（包头）
                store.commit('addLog', `${name}用绷带将${current_lili.name}从头到脚层层包裹起来。\n`)
                store.commit('addMinute', 30)
            ...
            const untieMummifiedHeadBinding=()=>{ // 解开绷带木乃伊（包头）
                store.commit('addLog', `${name}给${current_lili.name}解开了木乃伊拘束。\n`)
                current_lili = changeAttributes({input_lili:current_lili, bondage_ear:-2, bondage_mouth:-1, bondage_nose:-3, bondage_eye:-10,
                    bondage_arm:-10, bondage_finger:-10, bondage_lap:-10, bondage_shins:-10, bondage_foot:-10, bondage_toe:-10})
            ...
            const clickLigatureMummifiedBinding=()=>{ // 绷带木乃伊（不包头）
                store.commit('addLog', `${name}用绷带将${current_lili.name}脖颈之下层层包裹起来。\n`)
                store.commit('addMinute', 30)
            ...
            const clickTapeMimmifiedBinding=()=>{ // 胶带木乃伊（不包头）
                store.commit('addLog', `${name}用胶带将${current_lili.name}脖颈之下层层包裹起来。\n`)
                store.commit('addMinute', 30)
                current_lili = changeAttributes({input_lili:current_lili, bondage_arm:10, bondage_finger:10, bondage_lap:10, 
                    bondage_shins:10, bondage_foot:10, bondage_toe:10})
                handleMummifiedBinding()
            ...
            const clickOneStockings=()=>{ // 一层丝袜拘束
                store.commit('addLog', `${name}用一层丝袜将${current_lili.name}包裹起来。\n`)
            ...
            const untieOneStockings=()=>{ // 解开一层丝袜拘束
                store.commit('addLog', `${name}给${current_lili.name}解开了丝袜拘束。\n`)
                current_lili = changeAttributes({input_lili:current_lili, bondage_nose:-1, bondage_arm:-1, bondage_finger:-1, bondage_lap:-1, 
                    bondage_shins:-1, bondage_foot:-1, bondage_toe:-1})
            ...
            const clickTwoStockings=()=>{ // 两层丝袜拘束
                store.commit('addLog', `${name}用两层丝袜将${current_lili.name}包裹起来。\n`)
                store.commit('addMinute', 10)
            ...
            const clickThreeStockings=()=>{ // 三层丝袜拘束
                store.commit('addLog', `${name}用三层丝袜将${current_lili.name}包裹起来。\n`)
                store.commit('addMinute', 15)
            ...
            const clickFiveStockings=()=>{ // 五层丝袜拘束
                store.commit('addLog', `${name}用五层丝袜将${current_lili.name}包裹起来。\n`)
                store.commit('addMinute', 25)
            ...
            // 解开所有束缚
            const clickUntieAll=()=>{
                store.commit('addLog', `${name}给${current_lili.name}解开了全身所有的束缚。\n`)
                store.commit('addMinute', 10)
